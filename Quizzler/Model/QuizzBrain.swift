...
//  Quizzler
//
//  Created by Sergey on 31.01.2023.
//
...
struct QuizzBrain {
    ...
    func getQuestionText() -> String {
        ...
        return quiz[questionNumber].textOfQuestion
        
    }
    
    func getAnswerLabel() -> [String] {
        return quiz[questionNumber].answersOfQuestion
    }
    ...
    mutating func calculateScore(_ result: Bool) {
        if result {
            userScore += 1
        }
    }
